...
void main() {
  group('Reports & BI Providers Unit Tests', () {
    ...
    final testTrip = TripEntity(
      ...
      driverId: 'd_1',
      vehicleId: 'v_1',
      cargo: const {'description': 'Electronics', 'weightKg': 18000.0},
      route: const {
        'startLocationName': 'Chicago Hub',
        'endLocationName': 'New York Port',
        'estimatedDurationSec': 36000,
        'actualDurationSec': 38000,
      },
      checkpoints: const [],
      createdAt: now,
      updatedAt: now,
